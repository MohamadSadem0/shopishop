...
const CategoryCard = ({ category, onDelete, onEdit }) => {
  ...
  return (
    <>
      {isDesktop ? (
        <div className="bg-white shadow-lg rounded-lg w-[300px] transition duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-xl p-7 mr-2 my-2 flex flex-col space-y-2 sm:max-w-[300px]">
          {category.imageUrl && (
