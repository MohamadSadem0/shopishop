...
const StoreCard = ({ store, onViewDetails, onApprove }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg h-[200px] desktop:w-[280px] md:w-[200px] laptop:w-[230px] m-0 overflow-hidden transition duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-xl my-2 flex flex-col space-y-2">
